...
Window {
    ...
    Rectangle {
        ...
        // Поведение для автоматического возврата при изменении свойств
        Behavior on x {
            enabled: !isDragging && !moveAnimation.running && !returnToBoundsAnimation.running && !orientationAdjustAnimation.running
