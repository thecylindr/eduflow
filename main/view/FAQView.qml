    ...
    property var faqItems: [
        {
            ...
            answer: "Курсовая работа студента из техникума обучающегося на программиста, представляющая собой полноценную систему управления образовательным процессом EduFlow. Проект демонстрирует навыки разработки современного программного обеспечения с использованием передовых технологий."
        },
        {
        ...
        },
        {
            ...
            answer: isMobile ?
                "В разделе настроек 'Сервер' вы можете проверить ping до сервера. Нажмите 'Проверить ping' для измерения времени отклика. Рекомендуемое значение - менее 120 мс." :
                "Перейдите в Настройки -> Сервер. Используйте кнопку 'Проверить ping' для измерения времени отклика сервера. Круговая диаграмма визуализирует качество соединения."
        },
        {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text {
                            text: "Ответы на популярные вопросы о системе EduFlow"
